    ...
    <footer className="text-center text-white bg-[#003459]">
      <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 lg:justify-between">
        ...
        <div className="flex justify-center">
          <a className="mr-6 " href="https://twitter.com/its_lakshya">
            <svg
          ...
          <a className="mr-6" href="https://www.instagram.com/its.lakshya_/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4"
              fill="currentColor"
          ...
          <a className="mr-6" href="https://www.linkedin.com/in/lakshyakumar-/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4"
              fill="currentColor"
          ...
          <a href="https://github.com/its-lakshya">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4"
              fill="currentColor"
