    ...
    <div className="h-full flex flex-col justify-center  items-end w-1/2">
      <div className='flex flex-col items-center mr-4 gap-y-4'>
        <div className="flex gap-x-4">
          <div className="w-56 h-80 ResumeImage1 bg-cover border-r-[10px] border-t-[10px] rounded-l-[2rem] border-[#EA4492]">
            <img className="h-full w-full" alt="Resume" src={Resume1} />
          </div>
          <div className="w-56 h-80 ResumeImage2 bg-cover border-r-[10px] border-t-[10px] rounded-l-[2rem] border-[#428CD4]">
